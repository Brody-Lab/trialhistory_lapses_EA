...
%   params(2) =             gamma1, such that params(1) + params(2) is
%   asymptotic right poke frequency
%   params(3) =             beta, or sensitivity
%   params(4) =             alpha, or bias
%
...
function [neg_loglike] = negLogLike_logistic3(params, N, K, xregressor)

lapse   = params(1);
sens    = params(2);
bias    = params(3);
    
nDiff = numel(xregressor);
...
for d = 1:nDiff
    ...
    p = 0.5*lapse + ((1-lapse)/(1+exp(-sens*(x-bias))));
